...
export default function GeneralDetails(props) {
    ...
    useEffect(()=>{
     ...
     const [isChangePasseword, setIsChangePassword] = useState(false);
     const [selectedUserId , setSelectedUserId] = useState("");
 
     const handleChangePassword = (selectedId) =>{
        setSelectedUserId(selectedId);
        setIsChangePassword(!isChangePasseword);
     }

      // user details update
     const [isChangeUserDetails, setIsChangeUserDetails] = useState(false);

     const handleChangeUserDetails = (selectedId) =>{
        setSelectedUserId(selectedId);
        setIsChangeUserDetails(!isChangeUserDetails);
    }
    ...
    <>
        ...
        { isChangePasseword && (
            ...
            <div className="flex absolute  inset-0 items-center justify-center z-0 bg-black bg-opacity-75  w-full" > 
                ...
                <div  className="bg-[#ddd6fe] rounded p-2 mr-2 ml-2 mt-2 grid grid-cols-2 ">
                    ...
                    <button  onClick={handleChangePassword} type='reset'  className='ml-auto items-center col-span-1'>
                        <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                    </button>
                </div>
                    <ChangePassword selectedUserId={selectedUserId} />
                </div>
            </div>
        )}
        ...
        <div className="flex absolute inset-0 items-center justify-center z-0 bg-black bg-opacity-75 " > 
            ...
            <div  className="bg-[#ddd6fe] rounded p-2 mr-2 ml-2 mt-2 grid grid-cols-2 ">
                ...
                <button  onClick={handleChangeUserDetails} type='reset'  className='ml-auto items-center col-span-1'>
                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                </button>
                ...
                <EditUserDetails selectedUserId={selectedUserId} />
