...
function MyTasks() {
  ...
  return (
    <div className=" bg-gray-100 h-screen overflow-y-hidden  ">
      ...
      <div  className="bg-[#ddd6fee2]   dark:bg-gray-900  rounded flex md:flex-row flex-col p-1.5  my-1 mr-1 justify-between mx-1">
        <h1 className="text-left sm:text-lg font-bold text p-1.5 text-[#5c3c8f] dark:text-white ">My Tasks</h1>
      ...
      <div className=" mx-auto p-3 overflow-y-auto h-[90vh] -z-10">
