...
export default function ActualSummaryAngleChart() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async() =>{
      try{
        ...
        const response = await axios.get(`http://localhost:8000/api/actualcost-summary/1`,{
...
if (loading) {
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-semibold mb-4 text-center ">Actual Cost Summary</h2>
      <div id="chart">
