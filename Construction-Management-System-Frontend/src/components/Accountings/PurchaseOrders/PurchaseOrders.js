...
export default function PurchaseOrders() {
  ...
  const [isNewPurchaseOrder, setIsNewPurchaseOrder] = useState(false);
          ...
          <div className="flex absolute inset-0 items-center justify-center z-10 bg-black bg-opacity-75 " > 
            <div className='bg-white border border-violet-950 rounded-lg max-w-[80%] min-w-[70%] '>
              ...
              <div  className="bg-[#ddd6fe] rounded p-2 mr-2 ml-2 mt-2 grid grid-cols-2 ">
                <h1 className="text-left sm:text-xl font-bold ml-2 p-2 text-[#5c3c8f] col-span-1">  New Purchase Order </h1>
                <button  onClick={()=>setIsNewPurchaseOrder(false)} type='reset'  className='ml-auto items-center col-span-1'>
