...
export default function EquipmentUsageSummary(props) {
  ...
  return (
...

    {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 bg-gray-200">
            ...
            <div className="p-2">
            <p className="text-sm text-gray-500">Finished Logs</p>
            <p className="text-sm font-bold">{finishedLogs}</p>
            </div>
    
            <div className="p-2">
            <p className="text-sm text-gray-500">Completed Logs</p>
            <p className="text-sm font-bold">{finishedPercentage.toFixed(2)}%</p>
            </div>
    
            <div className="p-2">
            <p className="text-sm text-gray-500">Remaining Logs</p>
