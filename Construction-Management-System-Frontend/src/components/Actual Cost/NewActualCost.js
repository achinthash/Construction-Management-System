...
export default function NewActualCost() {
        ...
        <form  onSubmit={handleSubmit} className='  shadow-[0_3px_10px_rgb(0,0,0,0.4)]  bg-white dark:bg-gray-900 p-2   overflow-y-auto  rounded-lg text-black dark:text-white'>
          ...
          <div className='grid grid-cols-3  gap-2 '> 
            ...
            <div className="mb-2 w-full col-span-3 lg:col-span-1 md:col-span-3 px-3">
                <label className="text-start text-sm"> Estimation Id</label><br/>
                <input  className="border rounded-lg border-violet-950 w-full py-2 px-3 bg-white dark:bg-gray-800 " type="number" placeholder="Task Id" name="estimation_id"   value={formData.estimation_id} onChange={handleChange} />
            </div>
            ...
            <div className="mb-2 w-full col-span-3 lg:col-span-3 md:col-span-3 px-3">
                ...
                <textarea  className="border rounded-lg border-violet-950 w-full py-2 px-3 bg-white dark:bg-gray-800 " type="text" placeholder="change-cost" name="reason"   value={formData.reason} onChange={handleChange} > </textarea>
            </div>
